...
public class StudentMaster {
	public static void main(String[] args) {
		...
		al.add(new Student(01, "Rucha", "fifth", 80));
		al.add(new Student(02, "Sayali", "fifth", 90));
		al.add(new Student(03, "Sami", "third", 95));
		al.add(new Student(04, "Tilu", "sixth", 88));
		al.add(new Student(05, "Sakshi", "sixth", 85));

		al.add(new Student(05, "Neha", "fourth", 91));
